...
namespace UltimaCR.Rotations
{
    public sealed partial class Conjurer
    {
        ...
        {
            if (Core.Player.HasTarget && !Core.Player.CurrentTarget.HasAura(MySpells.Aero.Name, true, 4000))
            {
        ...
        {
            if (Ultima.UltSettings.ConjurerProtect && Ultima.LastSpell.Name != MySpells.Protect.Name &&
        ...
        {
            if (Core.Player.HasTarget && !Core.Player.CurrentTarget.HasAura(MySpells.AeroII.Name, true, 4000))
            {
